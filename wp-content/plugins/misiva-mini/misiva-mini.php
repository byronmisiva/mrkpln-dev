...
// Creación formulario
		...
		if ($user_ID != 0){
			...
			<div id="form-send-f" class="mfp-hide white-popup-block">
				...
				<form name="login" id="login" class="forma-login-envio">
					...
					<div class="campos-reservados">
						<input class="box-text" type="text" id="user_file_name" name="user_file_name" required="required"
			...
			<link rel='stylesheet'
				  href='http://localhost:10088/markplan/wp-admin/load-styles.php?c=0&amp;dir=ltr&amp;load=dashicons,buttons,media-views,wp-admin,wp-auth-check,wp-pointer,wp-jquery-ui-dialog&amp;ver=4.2.4'
				  type='text/css' media='all'/>

			<link rel='stylesheet' id='jqui-css-css'
				  href='http://localhost:10088/markplan/wp-content/plugins/download-manager/jqui/theme/jquery-ui.css?ver=4.2.4'
				  type='text/css' media='all'/>
				...
				<div class="subir-archiuvos col-md-12 col-sm-12 col-xs-12 margentabla ">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 margen0">
							<div id="post-body-content" style="position: relative;">
								...
								<div id="postdivrich" class="postarea wp-editor-expand">
                                    ...
                                    <textarea class="wp-editor-area" style="height:150px; margin-top: 37px;"
					...
					<div class="col-md-4 col-sm-12 col-xs-12 margen0">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<?php
							// pone categorias
							require_once(ABSPATH . 'wp-content/themes/flat/meta-boxes-misiva.php');
								...
								<div id="publishing-action">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 pull-right">
										...
										<input type="submit" value="Publicar"
											   class="button button-primary button-large  btn-subir-archivos" id="publicar"
											   name="publicar">
									</div>
								</div>
								<div class="clear"></div>
