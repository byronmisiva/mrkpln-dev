...
class wpdm_affiliate_widget extends WP_Widget {
    ...
    function wpdm_affiliate_widget() {
        parent::WP_Widget(false, 'WPDM Pro Affiliate');
    }
...
class wpdm_catpacks_widget extends WP_Widget {
    ...
    function wpdm_catpacks_widget() {
        parent::WP_Widget(false, 'WPDM Packages by Category');
    }
...
class wpdm_packageinfo_widget extends WP_Widget {
    ...
    function __construct() {
        parent::WP_Widget(false, 'WPDM Packages Info');
    }
    ...
    function widget($args, $instance) {
        ...
        if(isset($package_info['download_link'])){
            ...
            $download_link  = "<tr><td colspan='2' class='text-center'>" . wpdm_get_download_link(get_the_ID()) . "</td>";
        }
    ...
    function form($instance) {
        ...
        <p>
            ...
            <ul>
                ...
                <li><label><input type="checkbox" value="create_date" <?php checked(isset($package_info['create_date']), 1) ?> name="<?php echo $this->get_field_name('pinfo'); ?>[create_date]"> Fecha publicación</label></li>
                <li><label><input type="checkbox" value="update_date" <?php checked(isset($package_info['update_date']), 1) ?> name="<?php echo $this->get_field_name('pinfo'); ?>[update_date]"> Fecha carga</label></li>
                <li><label><input type="checkbox" value="download_link" <?php checked(isset($package_info['package_size']), 1) ?> name="<?php echo $this->get_field_name('pinfo'); ?>[package_size]"> Tamaño</label></li>
