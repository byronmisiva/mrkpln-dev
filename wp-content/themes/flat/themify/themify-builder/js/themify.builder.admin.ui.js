...
;(function($, window, document, undefined) {
	...
	ThemifyPageBuilder = {
		...
		bindEvents: function() {
			...
			/* lightbox */
			.on('click', '.close_lightbox', this.closeLightBox)
		...
		freezePage : function(){
			...
			$('body').contents().not('#themify_builder_overlay, #themify_builder_lightbox_parent').wrapAll( '<div id="builder-fixed-scroll" />' );
