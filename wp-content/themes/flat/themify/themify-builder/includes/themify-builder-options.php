								...
								<div class="themify_builder_field <?php echo (isset($field['wrap_with_class'])) ? $field['wrap_with_class'] : ''; ?>">
									...
									<div class="themify_builder_input"<?php echo $option['type'] == 'wp_editor' ? ' style="width:100%;"' : ''; ?>>
										<?php if( $option['type'] == 'text' ): ?>
											...
											<?php else : ?>
												<input name="<?php echo $option['id']; ?>" class="<?php echo $option['class']; ?> tfb_lb_option_child <?php echo $add_class; ?>" type="text" data-input-id="<?php echo $option['id']; ?>" />
			...
			?>
				<div class="themify_builder_input<?php echo isset($field['pushed']) && $field['pushed'] != '' ? ' '.$field['pushed'] : ''; ?>">
					<?php if( 'text' == $field['type'] ): ?>
						...
						<?php else : ?>
							<input id="<?php echo $field['id'] ?>" name="<?php echo $field['id'] ?>" value="<?php if(isset($field['value'])) echo $field['value']; ?>" class="<?php echo $field['class'] . $add_class; ?> tfb_lb_option" type="text" <?php echo themify_builder_get_binding_data( $field ); ?> />
					...
					<input id="<?php echo $field['id'] ?>" name="<?php echo $field['id'] ?>" value="<?php if(isset($field['value'])) echo $field['value']; ?>" class="themify_field_icon <?php echo $field['class']; ?> tfb_lb_option" type="text" <?php echo themify_builder_get_binding_data( $field ); ?> />
